...
class Solution:
    ...
    """ 6194. 最小 XOR #medium 给定两个数字 num1, num2. 要求找到一个「置位数」和num2相同的数字x, 使得x和num1的异或值最小. 
...
"""
    ...
    """ 6195. 对字母串可执行的最大删除数 #hard 给定一个字符串, 每次可以删除 1) 首位的l个字符, 要求 s[:l]==s[l:2*l]; 2) 所有字符. 问给定一个字符串, 全部删除所需的最大步数. 限制: n 4000.
