...
- 树状数组 Binary Index Tree: 单点修改, 区间和查询. 基本思想: 用 f[1010] 来记录 1001~1010之和 (位置从1开始计数), 因此对于前 1010个数字的和就是 f[1010]+f[1000]
- 线段树 Segment Tree: 单点修改, 区间查询, 比树状数组更复杂些但适用范围更广. 基本思想: 通过冗余的区间索引来记录特定范围内的统计指标. 注意对于n个数据需要开 4n 长度的数组.
